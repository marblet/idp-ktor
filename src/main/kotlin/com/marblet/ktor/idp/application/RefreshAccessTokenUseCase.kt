...
import com.marblet.ktor.idp.domain.model.RequestScopes
import com.marblet.ktor.idp.domain.model.TokenError
...
class RefreshAccessTokenUseCase(
    ...
    fun run(
        ...
        val authenticatedClient = clientBasicAuthentication.authenticate(authorizationHeader)
            ?: return Error.ClientAuthFailed.left()
        ...
        val requestScopes = RequestScopes.generate(scope, refreshTokenPayload.scopes)
            ?: return Error.InvalidScope.left()

        // verify consent
        val consent = consentRepository.get(refreshTokenPayload.userId, refreshTokenPayload.clientId)
            ?: return Error.ConsentNotFound.left()
